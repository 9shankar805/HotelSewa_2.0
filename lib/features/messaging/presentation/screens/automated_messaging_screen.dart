...
class _AutomatedMessagingScreenState extends State<AutomatedMessagingScreen> {
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(color: Color(AppConstants.successGreen).withOpacity(0.1), borderRadius: BorderRadius.circular(20)),
                child: Text('$enabledCount active', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Color(AppConstants.successGreen))),
              ),
            ),
          ),
        ],
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 12, color: isDark ? Colors.white70 : Color(AppConstants.darkGray)),
                  ),
                ),
              ],
            ),
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(t['timing'] as String, style: TextStyle(fontSize: 11, color: Color(AppConstants.mediumGray))),
                    ],
                  ),
                ),
                Switch.adaptive(
          ...
          if (enabled) ...[
            Container(
              ...
              child: Text(
                t['message'] as String,
                style: TextStyle(fontSize: 12, height: 1.5, color: Color(AppConstants.darkGray)),
                maxLines: 3,
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: Color(AppConstants.primaryRed),
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: Color(AppConstants.mediumGray),
  ...
  void _previewTemplate(Map<String, dynamic> t) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Container(
          padding: const EdgeInsets.all(14),
          decoration: BoxDecoration(color: Color(AppConstants.lightGray), borderRadius: BorderRadius.circular(10)),
  ...
  void _snack(String msg) => ScaffoldMessenger.of(context).showSnackBar(SnackBar(
    content: Text(msg), backgroundColor: Color(AppConstants.successGreen),

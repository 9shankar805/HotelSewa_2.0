...
class EarningsProvider extends ChangeNotifier {
  ...
  void _calculateSummary() {
    ...
    _revenueChange = '+${(5 + (_totalRevenue / 10000) * 10).toStringAsFixed(1)}%';
    _earningsChange = '+${(3 + (_netEarnings / 10000) * 8).toStringAsFixed(1)}%';
    _withdrawnChange = '+${(2 + (_withdrawnAmount / 10000) * 5).toStringAsFixed(1)}%';

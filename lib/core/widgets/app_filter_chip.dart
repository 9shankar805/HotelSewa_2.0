...
class AppFilterChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = activeColor ?? Color(AppConstants.primaryRed);
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: isSelected ? color : Color(AppConstants.mediumGray).withOpacity(0.3),
            ),
          ),
          child: Text(
            label,
            style: TextStyle(
              color: isSelected ? Colors.white : Color(AppConstants.mediumGray),

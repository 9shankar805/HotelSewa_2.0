...
import '../screens/hotel_registration_step1.dart';
import '../screens/hotel_registration_step2.dart';
import '../screens/hotel_registration_step3.dart';
import '../screens/hotel_registration_step4.dart';
...
class HotelRegistrationController extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const HotelRegistrationStep1(
...
class HotelRegistrationRoutes {
  ...
  static Map<String, Widget Function(dynamic)> routes = {
    step1: (data) => HotelRegistrationStep1(
      registrationData: data as HotelRegistrationData? ?? HotelRegistrationData(),
    ),
    step2: (data) => HotelRegistrationStep2(
      registrationData: data as HotelRegistrationData? ?? HotelRegistrationData(),
    ),
    step3: (data) => HotelRegistrationStep3(
      registrationData: data as HotelRegistrationData? ?? HotelRegistrationData(),
    ),
    step4: (data) => HotelRegistrationStep4(
      registrationData: data as HotelRegistrationData? ?? HotelRegistrationData(),
    ),
  };
}

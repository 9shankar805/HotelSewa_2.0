...
class HotelManagementService {
  ...
  static Future<Map<String, dynamic>> storeHotel({
    ...
    if (image != null) {
      ...
      return ApiService.uploadFile(ApiConfig.storeHotelEndpoint, image, token: _token, fields: strFields);
    }
    return ApiService.post(ApiConfig.storeHotelEndpoint, token: _token, data: fields);
  }
  ...
  static Future<Map<String, dynamic>> updateHotel(
    ...
    if (image != null) {
      final strFields = fields.map((k, v) => MapEntry(k, v.toString()));
      return ApiService.uploadFile('${ApiConfig.updateHotelEndpoint}/$id', image, token: _token, fields: strFields);
    }
    return ApiService.post('${ApiConfig.updateHotelEndpoint}/$id', token: _token, data: fields);
  }

  // DELETE /delete-hotel/{id} (also DELETE /hotels/{id})
  static Future<void> deleteHotel(String id) async {
    final response = await ApiService.delete('${ApiConfig.deleteHotelEndpoint}/$id', token: _token);
    if (response['success'] != true) {
  ...
  static Future<Map<String, dynamic>> updateAmenities(Map<String, dynamic> data) async {
    final response = await ApiService.post(ApiConfig.ownerAmenitiesEndpoint, token: _token, data: data);
  ...
  static Future<Map<String, dynamic>> storeRoomType(Map<String, dynamic> data) async {
    final response = await ApiService.post(ApiConfig.storeRoomTypeEndpoint, token: _token, data: data);
    if (response['success'] == true) return response['data'] ?? {};
  ...
  static Future<Map<String, dynamic>> updateRoomType(String id, Map<String, dynamic> data) async {
    final response = await ApiService.post('${ApiConfig.updateRoomTypeEndpoint}/$id', token: _token, data: data);
    if (response['success'] == true) return response['data'] ?? {};
  ...
  static Future<void> deleteRoomType(String id) async {
    final response = await ApiService.delete('${ApiConfig.deleteRoomTypeEndpoint}/$id', token: _token);
    if (response['success'] != true) {
  ...
  static Future<Map<String, dynamic>> storeRoom(Map<String, dynamic> data) async {
    final response = await ApiService.post(ApiConfig.storeRoomEndpoint, token: _token, data: data);
    if (response['success'] == true) return response['data'] ?? {};
  ...
  static Future<Map<String, dynamic>> updateRoom(String id, Map<String, dynamic> data) async {
    final response = await ApiService.post('${ApiConfig.updateRoomEndpoint}/$id', token: _token, data: data);
    if (response['success'] == true) return response['data'] ?? {};
  ...
  static Future<void> deleteRoom(String id) async {
    final response = await ApiService.delete('${ApiConfig.deleteRoomEndpoint}/$id', token: _token);
    if (response['success'] != true) {

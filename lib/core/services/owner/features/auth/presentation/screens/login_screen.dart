              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Hotel Owner', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w800, letterSpacing: -0.5)),
                    const SizedBox(height: 8),
                    const Text('Sign in to manage your property', style: TextStyle(color: Colors.white70, fontSize: 14)),
                  ],
                ),
              ),
